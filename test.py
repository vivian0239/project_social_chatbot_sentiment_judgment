...
#     if line[9] == '2':
#         p = os.getcwd()
#         p = p + '/train/pos/' + tmp + '.txt'
#         with open(p,'a') as f1:
#             f1.write(line[11:-1])
#     if line[9] == '1':
#         p = os.getcwd()
#         p = p + '/train/neg/' + tmp + '.txt'
#         with open(p,'a') as f1:
#             f1.write(line[11:-1])
#     line = f.readline()
#     # if n==200:
...
valid_dataset =  MovieReviewsDataset(path='/home/xingxin/PycharmProjects/csc874project/data/test/test1',use_tokenizer=tokenizer)
...
for epoch in tqdm(range(epochs)):
    ...
    # to find which case failed
    print("---------print the failed test cases---------- ")
    for i in range(len(valid_predict)):
        if valid_predict[i] != valid_labels[i]:
            print("predict: " + str(valid_predict[i]) + ", true: " + str(valid_labels[i]) + ", " + str(valid_dataset.__getitem__(i)))
    # Create the evaluation report.
    evaluation_report = classification_report(valid_labels, valid_predict, labels=list(labels_ids.values()),
